                    ...
                    navbarPage(NULL, position = "static-top", id = "tabs", collapsible = TRUE,  windowTitle = "Medicine Quality App",
                               tabPanel("Malaria", value = "malaria",
                                        ...
                                        fluidRow(
                                          ...
                                          column(width = 6,
                                                 div(class = "cent2",
                                                     actionButton("run_s1", "Run Scenario 1"), actionButton("run", "Run both Scenarios"), # actionButton("run_s2", "Run Scenario 2"),
                                                     br()
                                                 )
                                          ),
                                          column(width = 3)
                                        ...
                                        fluidRow(
                                          column(width = 6,
                                                 div(class = "borderscenario12",
                                                     plotOutput("plot_incidence_s1", height = "300px"), # %>% withSpinner(type = 4),
                                                     plotOutput("plot_global_s1", height = "300px") # %>% withSpinner(type = 4)
                                                 )
                                          ),
                                          column(width = 6,
                                                 div(class = "borderscenario22",
                                                     plotOutput("plot_incidence_s2", height = "300px"), # %>% withSpinner(type = 4),
                                                     plotOutput("plot_global_s2", height = "300px") # %>% withSpinner(type = 4)
                                                 )
                                          )
                                        ),
